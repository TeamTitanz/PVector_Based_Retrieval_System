 ...
 */
public class PVectorCalculator {

    private StanfordLemmatizer slem;
    private String serializedFolderPath = "D:\\Project\\fyp\\word2vec\\code\\work12\\finalSystem\\PVector_Based_Retrieval_System\\src\\main\\java\\org\\titans\\fyp\\test2\\Serialized_folder";
...
//                System.out.println("***" + word);
    ...
    public static void main(String[] args) {
        ...
        String paragraph = "I am gay. Me and my partner are married for 3 years now. " +
        ...
        PVectorCalculator pvc = new PVectorCalculator();

        for (double val : pvc.calculatePVector(paragraph)) {
